...
public class product_page5 extends Fragment implements OnClickListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View thispage=inflater.inflate(R.layout.product_page5, container, false);
		TextView pic1=(TextView)thispage.findViewById(R.id.product5_pic1);
		TextView pic2=(TextView)thispage.findViewById(R.id.product5_pic2);
		TextView pic3=(TextView)thispage.findViewById(R.id.product5_pic3);
		TextView pic4=(TextView)thispage.findViewById(R.id.product5_pic4);
	...
	public void onClick(View v) {
		...
		switch(v.getId())
		{
		case R.id.product5_pic1:
			  dialog = new Dialog(getActivity(),R.style.DailogStyle);
			  dialog.setContentView(R.layout.product5_pic1);
			  ...
			  dialog.show();
			break;
		case R.id.product5_pic2:
			  dialog = new Dialog(getActivity(),R.style.DailogStyle);
			  dialog.setContentView(R.layout.product5_pic2);
			  dialog.setTitle("Picture");
			  ...
			  dialog.show();
			break;
		case R.id.product5_pic3:
			  dialog = new Dialog(getActivity(),R.style.DailogStyle);
			  dialog.setContentView(R.layout.product5_pic3);
			  dialog.setTitle("Picture");
			  ...
			  dialog.show();
			break;
		case R.id.product5_pic4:
			  dialog = new Dialog(getActivity(),R.style.DailogStyle);
			  dialog.setContentView(R.layout.product5_pic4);
			  dialog.setTitle("Picture");
