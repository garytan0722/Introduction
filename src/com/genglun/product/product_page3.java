...
public class product_page3 extends Fragment implements OnClickListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View thispage=inflater.inflate(R.layout.product_page3, container, false);
		TextView pic1=(TextView)thispage.findViewById(R.id.product3_pic1);
		TextView pic2=(TextView)thispage.findViewById(R.id.product3_pic2);
		TextView pic3=(TextView)thispage.findViewById(R.id.product3_pic3);
		TextView pic4=(TextView)thispage.findViewById(R.id.product3_pic4);
	...
	public void onClick(View v) {
		...
		switch(v.getId())
		{
		case R.id.product3_pic1:
			  dialog = new Dialog(getActivity(),R.style.DailogStyle);
			  dialog.setContentView(R.layout.product3_pic1);
			  ...
			  dialog.show();
			break;
		case R.id.product3_pic2:
			  dialog = new Dialog(getActivity(),R.style.DailogStyle);
			  dialog.setContentView(R.layout.product3_pic2);
			  dialog.setTitle("Picture");
			  ...
			  dialog.show();
			break;
		case R.id.product3_pic3:
			  dialog = new Dialog(getActivity(),R.style.DailogStyle);
			  dialog.setContentView(R.layout.product3_pic3);
			  dialog.setTitle("Picture");
			  ...
			  dialog.show();
			break;
		case R.id.product3_pic4:
			  dialog = new Dialog(getActivity(),R.style.DailogStyle);
			  dialog.setContentView(R.layout.product3_pic4);
			  dialog.setTitle("Picture");
